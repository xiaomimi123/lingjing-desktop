  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        // 已在 sidebar 隐藏:Hermes 直接对话被砍后(/hermes/chat 转 banner),
        // 历史对话页已无法生成新记录,留着只看死数据。路由保留,直接 URL 仍可访问。
        meta: { title: '历史', icon: 'ChatbubblesOutline', gateway: 'hermes', section: 'use', hidden: true },
      },
      {
